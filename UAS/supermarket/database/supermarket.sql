...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Jun 2023 pada 06.02
...
(10, 4, 'air mineral', 'air mineral botol', 1, 0, '2023-03-28 16:04:04', NULL),
(11, 2, 'susu', 'susu untuk bayi', 1, 0, '2023-06-02 10:49:17', NULL);
...
(3, '202306-00001', 'mono', 'hj', 'ahm', 'Pria', '098728282', 'TES', 'adm@gmail.com', '9c6826252301b29503443ddd80a12a0f', NULL, 1, 0, '2023-06-02 10:39:01', NULL);
...
(5, 2, 1, 85, '2023-03-28 13:27:25'),
(6, 6, 1, 45.88, '2023-03-28 13:28:22'),
(7, 8, 1, 195.75, '2023-06-02 10:39:36');
...
(5, '202303-00001', 1, 1, 85, 'This is only my sample address', 2, '2023-03-28 13:27:25', '2023-03-28 13:31:14'),
(6, '202303-00002', 1, 2, 45.88, 'This is only my sample address', 0, '2023-03-28 13:28:22', '2023-03-28 13:28:22'),
(7, '202306-00001', 3, 2, 195.75, 'TES', 1, '2023-06-02 10:39:36', '2023-06-02 10:43:07');
...
(9, 4, 10, 'air mineral', '&lt;p&gt;tersedia iar menerlamnnds&lt;/p&gt;', 50000, 'products/cargo5.jpg', 1, 0, '2023-03-28 16:04:35', '2023-03-28 16:08:16'),
(10, 2, 11, 'susu', '&lt;p&gt;tersedia susu formula&lt;/p&gt;', 9000, 'uploads/products/4.jpg', 1, 0, '2023-06-02 10:46:12', '2023-06-02 10:53:35');

-- --------------------------------------------------------

--
-- Struktur dari tabel `shop_type_list`
--
...
--
-- Dumping data untuk tabel `shop_type_list`
--
...
(1, 'name', 'Marketplace Supermarket'),
(6, 'short_name', 'supermarket'),
(11, 'logo', 'uploads/Untitled.png'),
(13, 'user_avatar', 'uploads/user_avatar.jpg'),
(14, 'cover', 'uploads/Supermarket.jpg');
...
(1, 'Adminstrator', 'Admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'uploads/avatar-1.png?v=1644472635', NULL, 1, '2021-01-20 14:02:37', '2023-06-02 10:59:03'),
(11, 'budi', 'aj', 'budi', '4744ddea876b11dcb1d169fadf494418', 'uploads/avatar-11.png?v=1644472553', NULL, 2, '2022-02-10 13:55:52', '2023-06-02 10:59:42');

-- --------------------------------------------------------

--
-- Struktur dari tabel `vendor_list`
--
...
--
-- Dumping data untuk tabel `vendor_list`
--
...
(1, '202202-00001', 4, 'toko agung', 'Shop 101 Owner', '09123456788', 'shop101', 'ee6c4d4ba80f29dd389f0deb8863de69', 'uploads/vendors/1.png?v=1644375053', 1, 0, '2022-02-09 10:50:53', '2023-03-28 15:53:27'),
(2, '202202-00002', 1, 'toko nina', 'John Miller', '09123456789', 'Toko nina', '9c6826252301b29503443ddd80a12a0f', 'uploads/vendors/2.png?v=1644375129', 1, 0, '2022-02-09 10:52:09', '2023-06-02 10:42:31'),
...
(4, '202303-00001', 1, 'rahmad', 'rahmad jaya', '0878928328', 'rahmad', '9c6826252301b29503443ddd80a12a0f', NULL, 1, 0, '2023-03-28 15:59:08', NULL),
(5, '202306-00001', 2, 'meri', 'meri ak', '0812729292', 'meri', '9c6826252301b29503443ddd80a12a0f', NULL, 0, 1, '2023-06-02 11:01:23', '2023-06-02 11:02:25');
...
--
-- Indeks untuk tabel `shop_type_list`
--
...
--
-- Indeks untuk tabel `vendor_list`
--
...
--
-- AUTO_INCREMENT untuk tabel `shop_type_list`
--
ALTER TABLE `shop_type_list`
...
--
-- AUTO_INCREMENT untuk tabel `vendor_list`
--
ALTER TABLE `vendor_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Ketidakleluasaan untuk tabel `category_list`
--
ALTER TABLE `category_list`
...
--
-- Ketidakleluasaan untuk tabel `vendor_list`
--
ALTER TABLE `vendor_list`
